...
//   · 규칙 ②(쓰기 중단) 폐기 ………………………… **사용자 확정(2026-08-13).** 2026-08-11
//     담당자 확정을 뒤집은 것이고 **담당자에게 재확인하지 않았다.** 되돌아볼 일이 생기면
//     여기부터 물을 것.
 ...
 *  연습 페이지가 빠진다. (중단 규칙 ②에 의한 쓰기 페이지 제거는 사용자 확정 2026-08-13으로
 *  폐기 — 담당자 재확인 없음. 파일 상단 주석 참고) */
