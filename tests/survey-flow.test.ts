...
// 쓰기 중단(규칙 ②) 폐기는 담당자 확정(2026-08-22) — 「즉시 중단 기능 제거」가 ②를 포함한다.
// 이 describe의 전제(1번이 0점이어도 나머지를 다 입력해야 진행)는 그 확정을 고정한다.
describe('canAdvance — 쓰기는 전 문항 입력이 완료 조건이다 (중단 규칙 ② 폐기, 담당자 확정 2026-08-22)', () => {
