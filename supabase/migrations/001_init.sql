-- 이 파일은 구 001~015 마이그레이션을 하나로 합친 통합본이다(사용자 확정 2026-08-14).
-- 상쇄되거나 죽은 마이그레이션(001의 폐기 테이블, 002, 012+013+014, 011의 examiner_type,
-- 005의 구 record_login_failure)은 제외했다. 구 이력은 git log로 확인할 수 있다.
-- ════════════════════════════════════════════════════════════════════
-- 아동 읽기 선별검사 — 초기 스키마 (통합본)
-- 구 001~015를 하나로 합쳤다. 상쇄되는 마이그레이션(001의 폐기 테이블, 002,
-- 012+013+014, 011의 examiner_type, 005의 구 함수)은 제외했다.
