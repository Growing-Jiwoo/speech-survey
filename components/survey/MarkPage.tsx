...
// 중단 규칙 ①(의미 낱말 첫 3개 연속 오반응 → 무의미 낱말·문장 읽기유창성 미실시, 쓰기는 실시)은
// 검사 도중 판정해야 하므로, 녹음 직후 검사자가 방금 들은 반응을 표시한다. (검사지 인쇄 문구
// "문장 읽기유창성과 낱말 쓰기 미실시"는 폐기됨 — 담당자 확정 2026-08-11, 스펙 참고)
// 이 값은 관리자 채점의 초기값이 된다.
