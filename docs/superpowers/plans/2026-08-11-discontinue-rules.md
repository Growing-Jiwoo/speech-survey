...
**Task 6부터 계획대로 이어간다.** Task 1·2+3·4·5 모두 구현·스펙 리뷰·품질 리뷰 전부 완료됐다(위 참고 절).
Task 5가 끝나면서 "🚫 배포 금지" 절의 악화 중 PDF 쪽은 완전히 풀렸다 — 남은 건 ScoreBand
(Task 7)와 검사 화면 배너(Task 6)뿐이다.
