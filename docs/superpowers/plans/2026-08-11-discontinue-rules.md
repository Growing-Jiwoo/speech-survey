...
**Task 8부터 계획대로 이어간다.** Task 1·2+3·4·5·6·7 모두 구현·스펙 리뷰·품질 리뷰 전부
완료됐다(위 참고 절). "🚫 배포 금지" 절의 악화 사유(검사 화면 배너, 관리자 ScoreBand, PDF)가
전부 풀렸다 — 남은 건 마이그레이션 주석(Task 8)과 최종 검증(Task 9)뿐이다.
